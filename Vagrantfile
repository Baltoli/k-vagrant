Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    apt-get update
    apt-get install -y apache2 build-essential m4 openjdk-8-jdk libgmp-dev libmpfr-dev pkg-config flex bison z3 libz3-dev maven python3 cmake gcc zlib1g-dev libboost-test-dev libyaml-dev libjemalloc-dev python3-pip gdb
